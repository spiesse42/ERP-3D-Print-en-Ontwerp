      ...
      <div className="pbody listwrap">
        <table className="mini">
          <tbody>
            ...
            <tr><td><b>E-mail</b><div className="sub">offertes en werkbonnen mailen</div></td><td>{status(data?.mail)}</td><td className="sub">Gmail: SMTP_USER en SMTP_PASS (app-wachtwoord), optioneel SMTP_FROM, via de add-on-configuratie of omgevingsvariabelen. Nooit in de databank.</td></tr>
